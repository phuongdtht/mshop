				      		...
				      		<div class="form-group">
				      			<div class="row">
					      			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
					      				Tác giả : <input type="text" name="txtAuth" id="inputTxtAuth" class="form-control" value="{!! old('txtAuth',isset(Auth::guard('admin')->user()->name) ? Auth::guard('admin')->user()->name : null) !!}" required="required">
					      			</div>
